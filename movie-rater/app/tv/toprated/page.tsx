...
export default function Topratedtv() {
  ...
  const getTopRatedTvShows = useCallback(async (page: number) => {
     setLoading(true);
     setError(null);
   ...
   if (selectedLanguage) {
     ...
     endPoint = `/tv/top_rated?page=${page}&language=${selectedLanguage ?? "en-US"}`;
   }
  ...
  return (
    <main className="min-h-screen bg-gray-950">
      ...
      <MoviesFilter
              ...
              <h1 className="text-3xl font-bold text-white mb-6">Top Rated TV Shows</h1>    
