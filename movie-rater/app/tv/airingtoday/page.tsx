...
export default function Airingtodaytv() {
 ...
 const [selectedGenres, setSelectedGenres] = useState<number[]>([]);
    ...
    const getAiringTodayTvShows = useCallback(async (page: number) => {
       setLoading(true);
       setError(null);
     ...
     if (selectedLanguage) {
       ...
       endPoint = `/tv/airing_today?page=${page}&language=${selectedLanguage ?? "en-US"}`;
     }
  ...
  return (
    <main className="min-h-screen bg-gray-950">
      ...
      <MoviesFilter
                        ...
                        <h1 className="text-3xl font-bold text-white mb-6">Airing Today TV Shows</h1>    
